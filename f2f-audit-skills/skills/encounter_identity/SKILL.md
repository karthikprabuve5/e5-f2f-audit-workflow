...
compatibility: >-
  ...
  CMS files: /skills/encounter_identity/references/
  Client file: /skills/encounter_identity/clients/<client_name>/client-rules.md
---
...
Save to `/workspace/documents/outputs/encounter_identity/results.json`.
