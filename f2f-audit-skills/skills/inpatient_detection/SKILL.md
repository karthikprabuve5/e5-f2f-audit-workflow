...
compatibility: >-
  ...
  CMS files: /skills/inpatient_detection/references/
  Client file: /skills/inpatient_detection/clients/<client_name>/client-rules.md
---
...
Save to `/workspace/documents/outputs/inpatient_detection/results.json`.
