...
`/workspace/documents/outputs/poc_485_extraction/anchors.json`.
...
- `/skills/poc_485_extraction/SKILL.md` is the source of truth for all logic

## Workflow

1. Read `/skills/poc_485_extraction/SKILL.md` — follow it exactly.
2. Read `/workspace/documents/POC.md` — use page marker rule above.
3. Extract all five anchors per the skill instructions.
4. Save output to `/workspace/documents/outputs/poc_485_extraction/anchors.json`.
