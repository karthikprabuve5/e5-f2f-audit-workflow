...
the result to `/workspace/documents/outputs/skilled_services/results.json`.
...
- `/skills/skilled_services/SKILL.md` is the source of truth for all logic

## Workflow

1. Read `/skills/skilled_services/SKILL.md` — follow it exactly.
...
4. Save output to `/workspace/documents/outputs/skilled_services/results.json`.
