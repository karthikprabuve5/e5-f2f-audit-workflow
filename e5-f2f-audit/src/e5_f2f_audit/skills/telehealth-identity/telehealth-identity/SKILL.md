...
compatibility: >-
  ...
  CMS files: /skills/telehealth-identity/telehealth-identity/references/
  Client file: /skills/telehealth-identity/telehealth-identity/clients/<client_name>/client-rules.md
---
...
Output saved to `/workspace/documents/outputs/telehealth-identity/results.json`.
...
Save to `/workspace/documents/outputs/telehealth-identity/results.json`.
