...
compatibility: >-
  ...
  CMS files: /skills/poc-485-extraction/poc-485-extraction/references/
  Client file: /skills/poc-485-extraction/poc-485-extraction/clients/<client_name>/client-rules.md
---
...
Save to `/workspace/documents/outputs/poc-485-extraction/anchors.json`.
