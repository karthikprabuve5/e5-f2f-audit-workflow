...
compatibility: >-
  ...
  CMS files: /skills/skilled_services/references/
  Client file: /skills/skilled_services/clients/<client_name>/client-rules.md
---
...
Save to `/workspace/documents/outputs/skilled_services/results.json`.
