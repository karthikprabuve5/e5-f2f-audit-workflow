...
compatibility: >-
  ...
  CMS files: /skills/surgical_note/references/
  Client file: /skills/surgical_note/clients/<client_name>/client-rules.md
---
...
Save to `/workspace/documents/outputs/surgical_note/results.json`.
