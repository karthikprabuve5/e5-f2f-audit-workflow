...
Your only responsibility is to identify and classify every clinical encounter present in `/documents/F2F.md`.

## Workflow

1. Read `/documents/F2F.md`.
...
5. Save the output to the location `documents/F2F_classification_results.json`.
