...
save the result to `/workspace/documents/outputs/surgical-note/results.json`.
...
- `/skills/surgical-note/surgical-note/SKILL.md` is the source of truth for all logic

## Workflow

1. Read `/skills/surgical-note/surgical-note/SKILL.md` — follow it exactly.
...
4. Save output to `/workspace/documents/outputs/surgical-note/results.json`.
