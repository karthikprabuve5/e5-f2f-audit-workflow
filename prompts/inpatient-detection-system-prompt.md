...
`/workspace/documents/outputs/inpatient-detection/results.json`.
...
- `/skills/inpatient-detection/inpatient-detection/SKILL.md` is the source of truth for all logic

## Workflow

1. Read `/skills/inpatient-detection/inpatient-detection/SKILL.md` — follow it exactly.
...
4. Save output to `/workspace/documents/outputs/inpatient-detection/results.json`.
