...
the result to `/workspace/documents/outputs/primary-diagnosis/results.json`.
...
- `/skills/primary-diagnosis/primary-diagnosis/SKILL.md` is the source of truth for all logic

## Workflow

1. Read `/skills/primary-diagnosis/primary-diagnosis/SKILL.md` — follow it exactly.
...
4. Save output to `/workspace/documents/outputs/primary-diagnosis/results.json`.
