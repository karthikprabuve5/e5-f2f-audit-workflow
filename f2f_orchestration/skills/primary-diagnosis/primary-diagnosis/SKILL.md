...
compatibility: >-
  ...
  CMS files: /skills/primary-diagnosis/primary-diagnosis/references/
  Client file: /skills/primary-diagnosis/primary-diagnosis/clients/<client_name>/client-rules.md
---
