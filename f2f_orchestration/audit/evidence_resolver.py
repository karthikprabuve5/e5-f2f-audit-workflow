...
audit contract instead inlines the *resolved* evidence wherever it is cited, so the
downstream consumer never has to chase references.
...
class EvidenceResolver:
    ...
    def _project(entry: dict[str, Any], *, include_signal_strength: bool) -> dict[str, Any]:
        """Reduce a raw evidence entry to the inline audit shape (stable key order)."""
